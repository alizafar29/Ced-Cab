...
<html lang="en">
  ...
  <body>
      ...
      <div class="signUpHeader">
        ...
        <a id="gotoAdmin" class="hide btn btn-danger ml-5" href="user_dashboard.php"><button class="btn btn-danger">Goto Dashboard</button></a>
        <form action="admin/update_profile.php" method="POST">
        <div class="input-group flex-nowrap mb-3">
            ...
            <button type="button" name="submit" id="submit" class="btn btn-success btnC mb-3" disabled>Update</button>
  ...
  <script src="admin/update_profile.js"></script>
  </body>
</html>
